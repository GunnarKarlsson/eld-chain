...
pub struct ConsensusConfig {
    pub chain_id: String,
    #[serde(default)]
    pub fee_config: crate::fee::FeeConfig,
}
...
impl ConsensusConfig {
    ...
    pub fn from_file_for_test(file: &str) -> Self {
        crate::config_loader::ConfigLoader::load_for_test(file)
    }

    pub fn validate(&self) -> Result<(), crate::error::EldError> {
        if self.chain_id.trim().is_empty() {
            return crate::error::EldError::validation_error(
                "chain_id",
                "empty",
...
impl crate::config_loader::ConfigValidator for ConsensusConfig {
    fn validate(&self) -> Result<(), crate::error::EldError> {
        self.validate()
    }
}

impl crate::config_loader::ConfigLoadable for ConsensusConfig {}
...
impl crate::config_loader::ConfigValidator for CliConfig {
    fn validate(&self) -> Result<(), crate::error::EldError> {
        self.validate()
    }
}
...
mod tests {
    use super::*;
    use crate::constants::test::MOCK_CHAIN_ID;
    use std::fs;
